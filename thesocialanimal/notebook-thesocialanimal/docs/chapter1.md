...
1. **依从**：通常，一个人的行为的持续时间与他所得到的奖励承诺或所面临的惩罚威胁同样长。(最大权重：权力)
2. **认同**：和依从的区别是认同中我们的确相信自己所采取的意见或价值。这样做仅仅是为了与某个人或群体相像。(最大权重：吸引）
3. **内化**：`被认为值得信任而且具有很好的判断力的人` -- `施加影响` -- `接受他所主张的信念` -- `融入自己的价值体系`  (最大权重：可信性)
